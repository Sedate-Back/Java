...
- 案例需求
  ...
  把“E:
  ```
  \\itcast\\窗里窗外.txt”复制到模块目录下的“窗里窗外.txt”   (文件可以是任意文件)
- 实现步骤
  ...
  - 数据源：
    ...
    E:
    ```
    \\itcast\\窗里窗外.txt --- 读数据 --- InputStream --- FileInputStream
  - 目的地：
...
- 案例需求
  ...
  把“E:
  ```
  \\itcast\\mn.jpg”复制到模块目录下的“mn.jpg”  (文件可以是任意文件去)
- 实现步骤
...
+ IO流小结
  ...
  ![01_IO流小结](D:\java\09.IO流\day12-IO流day02\笔记\img\01_IO流小结.png)


## 5.转换流

### 5.1字符流中和编码解码问题相关的两个类【理解】
...
### 6.3serialVersionUID&transient【应用】
